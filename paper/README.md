...
**Status: PAPER READY WITH MINOR ADDITIONS, as an empirical analysis paper** (see [`research/PROGRESS.md`](../research/PROGRESS.md)).
...
- **Pending:** only A2, the end-to-end test of the fused Stage 1. It is marked `\pending{...}` and must be filled from its result file, never by hand.

## Sources of every number

| what | where it comes from |
|---|---|
| numbers in the prose | `generated/numbers.tex` (X*) and `generated/numbers_local.tex` (A1, B1, C1, D1, E1, F1, H1), written by `research/scripts/make_tables.py` from `research/results/*/metrics.json` |
